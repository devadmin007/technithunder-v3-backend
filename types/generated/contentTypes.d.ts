...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::blog.blog'> &
      Schema.Attribute.Private;
    minutesRead: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    publishedDate: Schema.Attribute.Date;
    slug: Schema.Attribute.UID;
    tag: Schema.Attribute.Component<'v1.tags', true>;
    thumbnailImage: Schema.Attribute.Media<'images' | 'files'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiDashboardDashboard extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    AwardsAndRecognized: Schema.Attribute.Component<
      'v1.awards-and-recognized',
      false
    >;
    Blogs: Schema.Attribute.Component<'v1.blogs', false>;
    CaseStudys: Schema.Attribute.Component<'v1.case-studys', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faqs: Schema.Attribute.Component<'v1.faqs', true>;
    HeroComponent: Schema.Attribute.Component<'v1.hero-component', false>;
    IndustryComponent: Schema.Attribute.Component<
      'v1.industry-component',
      false
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
    ...
    > &
      Schema.Attribute.Private;
    ProcessFlow: Schema.Attribute.Component<'v1.process-flow', false>;
    publishedAt: Schema.Attribute.DateTime;
    ReadyToEmbrance: Schema.Attribute.Component<'v1.ready-to-embrance', false>;
    ServiceComponent: Schema.Attribute.Component<'v1.service-component', false>;
    ToolsAndTechnology: Schema.Attribute.Component<
      'v1.tools-and-technology',
      false
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    WhatClientSays: Schema.Attribute.Component<'v1.what-client-says', false>;
    WhoweAreComponent: Schema.Attribute.Component<
      'v1.who-we-are-component',
      false
    >;
  };
}
...
export interface ApiHireHire extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::hire.hire'> &
      Schema.Attribute.Private;
...
export interface ApiIndustryIndustry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    HeroImage: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    HeroLogos: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    ...
    IndustryRelatedQuestions: Schema.Attribute.Component<
      'v1.industry-related-questions',
      false
    >;
    ItServices: Schema.Attribute.Component<'v1.it-services', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiServiceService extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    servicePartner: Schema.Attribute.Component<
      ...
      false
    >;
    servicesInfo: Schema.Attribute.Component<
      'v1.services-info-component',
      false
    >;
    slug: Schema.Attribute.UID;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Authority: Schema.Attribute.Enumeration<['Leadership', 'Employee']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::team.team'> &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    profileImg: Schema.Attribute.Media<'images' | 'files'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiToolsAndTechnologyToolsAndTechnology
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Technology: Schema.Attribute.Component<'v1.technology', true>;
    Title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
