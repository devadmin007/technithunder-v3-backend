...
export interface ApiBlogBlog extends Schema.CollectionType {
  ...
  attributes: {
    ...
    blogDetail: Attribute.DynamicZone<['v1.image', 'v1.rich-text']>;
    blogSubTitle: Attribute.String;
    ...
    createdBy: Attribute.Relation<'api::blog.blog', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    minutesRead: Attribute.Integer;
    publishedAt: Attribute.DateTime;
    publishedDate: Attribute.Date;
    slug: Attribute.UID;
    tag: Attribute.Component<'v1.tags', true>;
    thumbnailImage: Attribute.Media<'images' | 'files'>;
    updatedAt: Attribute.DateTime;
...
export interface ApiCasestudyCasestudy extends Schema.CollectionType {
  ...
  attributes: {
    casestudySection: Attribute.Component<'v1.casestudy-content'>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
    ...
    publishedAt: Attribute.DateTime;
    Skill: Attribute.Component<'v1.skills', true>;
    ThumbnailImg: Attribute.Media<'images' | 'files'>;
...
export interface ApiIndustryIndustry extends Schema.CollectionType {
  ...
  attributes: {
    ...
    IndustryRelatedQuestions: Attribute.Component<'v1.industry-related-questions'>;
    ItServices: Attribute.Component<'v1.it-services'>;
    publishedAt: Attribute.DateTime;
    SegmentsWeServe: Attribute.Component<'v1.segments-we-serve'>;
    slug: Attribute.UID;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::industry.industry',
    ...
    > &
      Attribute.Private;
    WeDevelop: Attribute.Component<'v1.we-develop'>;
    WhatYouNeed: Attribute.Component<'v1.what-you-need'>;
  };
}
...
export interface ApiServiceService extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    faqs: Attribute.Component<'v1.que-ans-component', true>;
    heroImage: Attribute.Media<'images' | 'files'>;
    heroTitle: Attribute.String;
    keyBenefits: Attribute.Component<'v1.key-benefits'>;
    publishedAt: Attribute.DateTime;
    segmentsWeServe: Attribute.Component<'v1.segments-we-serve-component'>;
    serviceName: Attribute.String;
    servicePartner: Attribute.Component<'v1.service-partner-component'>;
    servicesInfo: Attribute.Component<'v1.services-info-component'>;
    slug: Attribute.UID;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::service.service',
    ...
    > &
      Attribute.Private;
    whyChooseUs: Attribute.Component<'v1.why-choose-us-component'>;
  };
}
...
export interface ApiTeamTeam extends Schema.CollectionType {
  ...
  attributes: {
    Authority: Attribute.Enumeration<['Leadership', 'Employee']>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::team.team', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    designation: Attribute.String;
    name: Attribute.String;
    profileImg: Attribute.Media<'images' | 'files'>;
    publishedAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
